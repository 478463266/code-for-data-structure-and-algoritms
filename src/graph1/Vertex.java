package graph1;
//ref:https://github.com/hapjin/data-structures-and-abstraction-with-java/blob/master/graph/VertexInterface.java
//explain: https://www.cnblogs.com/hapjin/p/4760934.html
...
public class Vertex<T> implements VertexInterface<T>, java.io.Serializable {
    ...
    private class NeighborIterator implements Iterator<VertexInterface<T>>{
        ...
        public VertexInterface<T> next() {
            ...
            if (edgesIterator.hasNext()){
                Edge edgeToNextNeighbor = edgesIterator.next();////LinkedList中存储的是Edg
    ...
    public boolean hasNeighbor() {
        return !(edgeList.isEmpty());//邻接点实质是存储在List中
    }
    ...
    public VertexInterface<T> getUnvisitedNeighbor() {
        ...
        while (neighbors.hasNext() && result == null)//获得顶点的下一个未被访问的邻接点
        {
            VertexInterface<T> nextNeighbor = neighbors.next();
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(label, vertex.label);//节点是否相同最终还是由标识 节点类型的类的equals() 决定
    }
